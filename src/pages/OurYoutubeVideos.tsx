...
const OurYoutubeVideos = () => {
    return (
      ...
      <Nav/>
        <section className='md:h-full flex items-center text-gray-600'>
          <div className='container px-5 py-20 mx-auto'>
            <div className='text-center mb-12'>
              {/* <h5 className='text-base mb:text-lg text-amber-700 mb-1'>See Our recent videos</h5> */}
              <h1 className='text-4xl md:text-6xl text-gray-700 font-semibold'>See Our recent videos</h1>
            </div>
            <div className='flex flex-wrap -m-4'>
              <div className='p-4 sm:w-1/2 lg:w-1/3'>
                <div className='h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden'>
                  ...
                  />
                  <div className='p-6 hover:bg-amber-700 hover:text-white transition duration-300 ease-in cursor-pointer'>
                    <h2 className='text-base font-medium text-amber-300 mb-1'>October 21, 2020</h2>
        ...
        {/* <h1 className='text-amber-600 text-4xl text-center py-20 font-bold'>Algumas de nossas apresentações!</h1> */}
        {/* <div> 
          <ul>
            <li>
              <div>
