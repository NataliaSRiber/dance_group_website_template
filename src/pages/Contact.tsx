...
const Contact = (props: any) => {
    return (
      <>
      <Nav />
      <section className='flex flex-col md:py-32 pt-32 pb-16 md:px-20 px-10 body-font font-instrument'>
      <h1 className='text-3xl md:text-5xl text-gray-700 font-semibold text-center pb-10'>Contato</h1>
        ...
        <div className='text-xl text-left'>
          <h1 className='z md:pb-8 text-xl md:text-2xl pb-8 font-bold text-center text-blue-400'>Diretoria e coordenações</h1>
          <div>
            <p className='font-semibold text-lg md:text-lg pb-2'>Joaquina Silva</p>
          ...
          <div>
            <p className='font-semibold pb-2 text-md md:text-lg'>Rúbia Rosa</p>
          ...
          <div>
            <p className='font-semibold pb-2 text-md md:text-lg'>Carmen Lúcia</p>
            <p className='font-light text-sm md:text-lg pb-2'>Tesoureira</p>
            <p className='font-light text-sm md:text-lg pb-6'>Contato: (35)99800-2234</p>
          </div>
          <div>
            <p className='font-semibold pb-2 text-md md:text-lg'>Lúcio Almeida</p>
